...
let post = async function (comment_object) {
    commentObjectfull.push(comment_object);
    console.log(commentObjectfull.length);
    // if(commentObjectfull.length === 10000) {
        fs.writeFileSync('../reports/maindata.json', '');

        fs.writeFileSync('../reports/maindata.json', JSON.stringify(commentObjectfull));
...
run("https://twitter.com/search?q=Bournvita%20&src=typed_query&f=live");